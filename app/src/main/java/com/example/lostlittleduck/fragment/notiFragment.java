...
import com.example.lostlittleduck.adapter.NotiDeviceAdapter;
import com.example.lostlittleduck.comm.ObserverManager;

import java.util.List;

public class notiFragment extends Fragment {
    private NotiDeviceAdapter mDeviceAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.noti_fragment, container, false);
    ...
    private void initView(final View rootView) {
        ...
        mDeviceAdapter = new NotiDeviceAdapter(getActivity());
        mDeviceAdapter.setOnDeviceClickListener(new NotiDeviceAdapter.OnDeviceClickListener(){
